          ...
          <form action="" onSubmit={handleSubmit} autoComplete="off">
            <div className='lg:flex md:flex items-center justify-between gap-5'>
              <div className="py-1 lg:w-[50%] md:w-[50%]">
                ...
                <input 
                  ...
                  placeholder=''
                  onBlur={handleBluer}
                  className={`mt-2 outline outline-2 outline-black px-6 py-4 rounded-3xl ${errors.Nama && touched.Nama ? "input-error w-full":"block mx-auto text-black  w-full "}`} 
                />
              ...
              <div className="py-1 lg:w-[50%] md:w-[50%] md:mt-0 mt-5 lg:mt-0">
                ...
                <input 
                  ...
                  placeholder=''
                  onBlur={handleBluer}
                  className={`mt-2 outline outline-2 outline-black px-6 py-4 rounded-3xl ${errors.Email && touched.Email ? "input-error w-full":"block mx-auto text-black  w-full "}`}
                />
            ...
            <div className="py-1 mt-5">
                ...
                <input 
                  ...
                  placeholder=''
                  onBlur={handleBluer}
                  className={`mt-2 outline outline-2 outline-black px-6 py-4 rounded-3xl ${errors.Subject && touched.Subject ? "input-error w-full":"block mx-auto text-black  w-full "}`} 
                />
            ...
            <div className="py-1 mt-5">
                ...
                <textarea 
                  ...
                  placeholder=''
                  onBlur={handleBluer}
                  className={`mt-2 outline outline-2 outline-black px-6 py-4 rounded-3xl ${errors.Massage && touched.Massage ? "input-error w-full":"block mx-auto text-black  w-full "}`}  
                />
