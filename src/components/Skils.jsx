...
const Skil =  () =>{
    return(
        <div className="px-10 mx-auto lg:mt-28 -mt-10 sm:mt-32" id="skils">
            <h1 className="uppercase text-center lg:text-5xl text-2xl md:text-5xl font-bold">profesional Skills </h1>
            <p className=" text-hijau font-bold text-center mt-7">MY <span className="text-black decor text-3xl tracking-widest">Talent</span></p>
